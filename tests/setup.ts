...
const mockElectronAPI = {
  ...
  cardsGenerateFromText: jest.fn().mockResolvedValue({ success: true, count: 15 }),
  ...
  getConceptDependencies: jest.fn().mockResolvedValue([]),
  addConceptDependency: jest.fn().mockResolvedValue({ success: true, id: 1 }),
  deleteConceptDependency: jest.fn().mockResolvedValue({ success: true }),
  ...
  tutorUpdateSessionDuration: jest.fn().mockResolvedValue({ success: true }),
